...
namespace Agenda_C.Controllers
{
    ...
    public class PersonasController : Controller
    {
        ...
        public PersonasController(AgendaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Email,Nombre,Apellido,DNI")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(String id, [Bind("Id,UserName,Email,Nombre,Apellido,DNI")] Persona persona)
        {
            if (id != persona.Id)
            {
                return NotFound();
